...
rsync -axv -e 'ssh -p 50022 -o "StrictHostKeyChecking=no" -i /home/redelk/.ssh/id_rsa' $3@$1:~/logs /var/www/html/cslogs/$2 >> $LOGFILE 2>&1
rsync -axv -e 'ssh -p 50022 -o "StrictHostKeyChecking=no" -i /home/redelk/.ssh/id_rsa' $3@$1:~/downloads /var/www/html/cslogs/$2 >> $LOGFILE 2>&1
rsync -axv -e 'ssh -p 50022 -o "StrictHostKeyChecking=no" -i /home/redelk/.ssh/id_rsa' $3@$1:~/profiles /var/www/html/cslogs/$2 >> $LOGFILE 2>&1
